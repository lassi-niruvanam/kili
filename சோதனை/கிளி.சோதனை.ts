...
describe("கிளி", () => {
  ...
  describe("பேற்றோர்கள்", function () {
    ...
    beforeEach(async () => {
      ...
      தம்பி_அடையாளம் = await கிளி.உருவாக்கு({
        விண்மீன்,
        வார்ப்புரு,
        பேற்றோர்,
        அட்டவணை_சாபி: "அட்டவணை சாபி",
      ...
      கிளியின்_தம்பி = new கிளி({
        விண்மீன்,
        அட்டவணை_சாபி: "அட்டவணை சாபி",
        குழு_அடையாளம்: தம்பி_அடையாளம்,
        வார்ப்புரு,
      });
    });
    ...
    it("பேற்றோரின் அங்கீகரிக்கப்பட்ட உறுப்படிகள்", async () => {
      ...
      expect(மதிப்பு).to.deep.eq([
        {
          données: {
            [பங்கேற்பாளர்_நெடுவரிசை_அடையாளம்]: await விண்மீன்.obtIdCompte(),
            உரை: "சரகம",
            எண்: 123,
            [தேதி_நெடுவரிசை_அடையாளம்]: மதிப்பு[0].données[தேதி_நெடுவரிசை_அடையாளம்],
          },
          id: மதிப்பு[0].id,
        },
      ]);
    ...
    it("தம்பியின் பரிந்துரைகள் வந்ததில்லை", async () => {
      const பரிந்துரைகள் = new attente.AttendreRésultat<
        பிணையம்_பரிந்துரை<{ உரை: string; எண்: number }>[]
      >();
      const { fOublier: என்_பரிந்துரைகளை_மறந்துவிடு } =
      ...
      await கிளியின்_தம்பி.பரிந்துரையு({
        பரிந்துரை: {
          எண்: 123,
          உரை: "சரகம",
        },
    ...
    it("தம்பியின் அங்கீகறிக்கப்பட்ட தரவுகள் வந்ததில்லை", async () => {
      const தம்பியின்_பரிந்துரைகள் = new attente.AttendreRésultat<
        பிணையம்_பரிந்துரை<{ உரை: string; எண்: number }>[]
      >();
      const { fOublier: தம்பியின்_பரிந்துரைகளை_மறந்துவிடு } =
        await கிளியின்_தம்பி.பரிந்துரைகளை_கேள்ளு({
          செ: (ப) => தம்பியின்_பரிந்துரைகள்.mettreÀJour(ப),
        });
      மறந்துவிடு.push(தம்பியின்_பரிந்துரைகளை_மறந்துவிடு);

      const பேற்றோரின்_பரிந்துரைகள் = new attente.AttendreRésultat<
        பிணையம்_பரிந்துரை<{ உரை: string; எண்: number }>[]
      >();
      const { fOublier: பேற்றோரின்_பரிந்துரைகளை_மறந்துவிடு } =
        await கிளியின்_பேற்றோர்.பரிந்துரைகளை_கேள்ளு({
          செ: (ப) => பேற்றோரின்_பரிந்துரைகள்.mettreÀJour(ப),
        });
      மறந்துவிடு.push(பேற்றோரின்_பரிந்துரைகளை_மறந்துவிடு);
      ...
      const தம்பியின்_பரிந்துரை = (
        await தம்பியின்_பரிந்துரைகள்.attendreQue((ப) => ப.length > 0)
      )[0];
      await கிளியின்_தம்பி.அங்கீகரி({
        பரிந்துரை: தம்பியின்_பரிந்துரை,
      });
      ...
      const பேற்றோரின்_பரிந்துரை = (
        await பேற்றோரின்_பரிந்துரைகள்.attendreQue((பரிந்துரைகள்) => !!பரிந்துரைகள்.find(ப=>ப.பரிந்துரை.எண் === 456))
      ).find(ப=>ப.பரிந்துரை.எண் === 456)!;

      await கிளியின்_பேற்றோர்.அங்கீகரி({
        பரிந்துரை: பேற்றோரின்_பரிந்துரை,
      });
    ...
    it("சந்ததியின் பரிந்துரைகள் கிடைக்கும்", async () => {
      const பரிந்துரைகள் = new attente.AttendreRésultat<
        பிணையம்_பரிந்துரை<{ உரை: string; எண்: number }>[]
      >();
      const { fOublier: என்_பரிந்துரைகளை_மறந்துவிடு } =
  ...
  describe("இணையம்", function () {
    ...
    it("உறுப்படிகள் - என் பரிந்துரைகள்", async () => {
