...
export type தேதியுடன்_பரிந்துரை_வகை<
  ...
  தேதி_நேடுவரிசை_வ extends string = typeof தேதி_நெடுவரிசை_அடையாளம்,
> = வ & {
  [தேதி in தேதி_நேடுவரிசை_வ]: number;
};
...
> = {
  பங்கேற்பாளர்: string;
  கைரேகை: string;
  பரிந்துரை: தேதியுடன்_பரிந்துரை_வகை<வ, தேதி_நேடுவரிசை_வ>;
};
...
export type அங்கீகரிக்கப்பட்ட_உறுப்படி_வகை<
  ...
  தேதி_நேடுவரிசை_வ extends string = typeof தேதி_நெடுவரிசை_அடையாளம்,
> = தேதியுடன்_பரிந்துரை_வகை<வ, தேதி_நேடுவரிசை_வ> & {
...
> {
  ...
  மாறிலிகள்: Omit<
    typeof முன்னிருப்பாக_மாறிலிகள், "பங்கேற்பாளர்_நெடுவரிசை_அடையாளம்" | "தேதி_நெடுவரிசை_அடையாளம்"
  > & {
    பங்கேற்பாளர்_நெடுவரிசை_அடையாளம்: பங்கேற்பாளர்_நெடுவரிசை_வ,
    தேதி_நெடுவரிசை_அடையாளம்: தேதி_நேடுவரிசை_வ,
  };
  ...
  constructor({
    ...
    குழு_அடையாளம்: string;
    வார்ப்புரு: bds.schémaSpécificationBd;
    மாறிலிகள்?: கிளி<வ, பங்கேற்பாளர்_நெடுவரிசை_வ, தேதி_நேடுவரிசை_வ>["மாறிலிகள்"];
  }) {
  ...
  static வார்ப்புரு_தயாரிப்பு({
    ...
    const தேதி_நெடுவரிசை_உள்ளதா = வேண்டிய_அட்டவணை.cols.find(
      (நெடுவரிசை) =>
        நெடுவரிசை.idColonne === (மாறிலிகள்?.தேதி_நெடுவரிசை_அடையாளம் ||
        தேதி_நெடுவரிசை_அடையாளம்),
    );
  ...
  async பரிந்துரைகளை_கேள்ளு({
    ...
    செ: types.schémaFonctionSuivi<பிணையம்_பரிந்துரை<வ, தேதி_நேடுவரிசை_வ>[]>;
  ...
  async பரிந்துரையு({ பரிந்துரை }: { பரிந்துரை: வ }): Promise<void> {
    const தேதியை_சேரு = (
      உறுப்படி: வ | தேதியுடன்_பரிந்துரை_வகை<வ, தேதி_நேடுவரிசை_வ>,
    ): தேதியுடன்_பரிந்துரை_வகை<வ, தேதி_நேடுவரிசை_வ> => {

      if (!உறுப்படி[this.மாறிலிகள்.தேதி_நெடுவரிசை_அடையாளம்]) {
        return {...உறுப்படி, [this.மாறிலிகள்.தேதி_நெடுவரிசை_அடையாளம்]: Date.now()};
      }
      return உறுப்படி as தேதியுடன்_பரிந்துரை_வகை<வ, தேதி_நேடுவரிசை_வ>;
    };
  ...
  async அங்கீகரி({
    ...
    பரிந்துரை: பிணையம்_பரிந்துரை<வ, தேதி_நேடுவரிசை_வ>;
  }) {
