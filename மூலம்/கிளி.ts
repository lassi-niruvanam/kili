...
export type அங்கீகரிக்கப்பட்ட_உறுப்படி_வகை<வ extends பரிந்துரை_வகை> = வ & {
...
export class கிளி<வ extends பரிந்துரை_வகை> {
    ...
    async பரிந்துரைகளை_கேள்ளு({
      ...
      return await this.விண்மீன்.nuées.suivreDonnéesTableauNuée<வ>({
    ...
    async எனது_பரிந்துரைகளை_கேள்ளு({
      ...
      return await this.விண்மீன்.bds.suivreDonnéesDeTableauUnique<வ>({
