...
export class கிளி<வ extends பரிந்துரை_வகை> {
  ...
  static async உருவாக்கு({
    ...
    if (!விண்மீன்.nuées || !விண்மீன்.bds)
      ...
      வார்ப்புரு = this.வார்ப்புரு_தயாரிப்பு({ வார்ப்புரு, அட்டவணை_சாபி, குழு_அடையாளம்});
  ...
  async அங்கீகரிக்கப்பட்ட_உறுப்படிகளை_கேள்ளு({
    ...
    செ: utils.schémaFonctionSuivi<
      valid.élémentDonnées<அங்கீகரிக்கப்பட்ட_உறுப்படி_வகை<வ>>[]
    >;
  ...
  async அங்கிகரிக்கப்பட்ட_உறுப்படியை_திருத்து({
    உறுப்படி,
    கைரேகை,
  }: {
    உறுப்படி: வ;
